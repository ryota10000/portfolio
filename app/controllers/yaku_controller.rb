class YakuController < ApplicationController
  ...
  def index
    ...
    @fu_values = {
      "順子(0)" => { han: 0, fu: 0 },
      "一九字牌のポン(4)" => { han: 0, fu: 4 },
      "一九字牌のアンコ(8)" => { han: 0, fu: 8 },
      "一九字牌のミンカン(16)" => { han: 0, fu: 16 },
      "一九字牌のアンカン(32)" => { han: 0, fu: 32 },
      "二〜八のポン(2)" => { han: 0, fu: 2 },
      "二〜八のアンコ(4)" => { han: 0, fu: 4 },
      "二〜八のミンカン(8)" => { han: 0, fu: 8 },
      "二〜八のアンカン(16)" => { han: 0, fu: 16 },

      "一〜九 / 客風牌(0)" => { han: 0, fu: 0 },
      "自風牌 / 場風牌 / 三元牌(2)" => { han: 0, fu: 2 },
      "連風牌(4)" => { han: 0, fu: 4 },

      "リャンメン / シャンポン(0)" => { han: 0, fu: 0 },
      "カンチャン / ペンチャン / タンキ / ノベタン(2)" => { han: 0, fu: 2 }
    }
